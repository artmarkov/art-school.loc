        ...
        <div class="modal-content">
            <div class="dropdown-header bg-trans-gradient d-flex justify-content-center align-items-center w-100">
                <h4 class="m-0 text-center color-white">
                    <?= Yii::t('art/layout', 'Layout Settings')?>
                    <small class="mb-0 opacity-80"><?= Yii::t('art/layout', 'User Interface Settings')?></small>
                </h4>
                ...
                <div class="settings-panel">
                    <div class="mt-4 d-table w-100 px-5">
                        <div class="d-table-cell align-middle">
                            <h5 class="p-0">
                                <?= Yii::t('art/layout', 'App Layout')?>
                            </h5>
                        </div>
                    </div>
                    <div class="list" id="fh">
                        <a href="#" onclick="return false;" class="btn btn-switch" data-action="toggle" data-class="header-function-fixed"></a>
                        <span class="onoffswitch-title"><?= Yii::t('art/layout', 'Fixed Header')?></span>
                        <span class="onoffswitch-title-desc"><?= Yii::t('art/layout', 'header is in a fixed at all times')?></span>
                    </div>
                    <div class="list" id="nff">
                        <a href="#" onclick="return false;" class="btn btn-switch" data-action="toggle" data-class="nav-function-fixed"></a>
                        <span class="onoffswitch-title"><?= Yii::t('art/layout', 'Fixed Navigation')?></span>
                        <span class="onoffswitch-title-desc"><?= Yii::t('art/layout', 'left panel is fixed')?></span>
                    </div>
                    <div class="list" id="nfm">
                        <a href="#" onclick="return false;" class="btn btn-switch" data-action="toggle" data-class="nav-function-minify"></a>
                        <span class="onoffswitch-title"><?= Yii::t('art/layout', 'Minify Navigation')?></span>
                        <span class="onoffswitch-title-desc"><?= Yii::t('art/layout', 'Skew nav to maximize space')?></span>
                    </div>
                    <div class="list" id="nfh">
                        <a href="#" onclick="return false;" class="btn btn-switch" data-action="toggle" data-class="nav-function-hidden"></a>
                        <span class="onoffswitch-title"><?= Yii::t('art/layout', 'Hide Navigation')?></span>
                        <span class="onoffswitch-title-desc"><?= Yii::t('art/layout', 'roll mouse on edge to reveal')?></span>
                    </div>
                    <div class="list" id="nft">
                        <a href="#" onclick="return false;" class="btn btn-switch" data-action="toggle" data-class="nav-function-top"></a>
                        <span class="onoffswitch-title"><?= Yii::t('art/layout', 'Top Navigation')?></span>
                        <span class="onoffswitch-title-desc"><?= Yii::t('art/layout', 'Relocate left pane to top')?></span>
                    </div>
                    <div class="list" id="fff">
                        ...
                        <span class="onoffswitch-title"><?= Yii::t('art/layout', 'Fixed Footer')?></span>
                        <span class="onoffswitch-title-desc"><?= Yii::t('art/layout', 'page footer is fixed')?></span>
                    </div>
                    <div class="list" id="mmb">
                        <a href="#" onclick="return false;" class="btn btn-switch" data-action="toggle" data-class="mod-main-boxed"></a>
                        <span class="onoffswitch-title"><?= Yii::t('art/layout', 'Boxed Layout')?></span>
                        <span class="onoffswitch-title-desc"><?= Yii::t('art/layout', 'Encapsulates to a container')?></span>
                    </div>
                    <div class="expanded">
                        <ul class="mb-3 mt-1">
                            <li>
                        ...
                        <div class="list" id="mbgf">
                            ...
                            <span class="onoffswitch-title"><?= Yii::t('art/layout', 'Fixed Background')?></span>
                        </div>
                    </div>
                    <div class="mt-4 d-table w-100 px-5">
                        <div class="d-table-cell align-middle">
                            <h5 class="p-0">
                                <?= Yii::t('art/layout', 'Mobile Menu')?>
                            </h5>
                        </div>
                    </div>
                    <div class="list" id="nmp">
                        <a href="#" onclick="return false;" class="btn btn-switch" data-action="toggle" data-class="nav-mobile-push"></a>
                        <span class="onoffswitch-title"><?= Yii::t('art/layout', 'Push Content')?></span>
                        <span class="onoffswitch-title-desc"><?= Yii::t('art/layout', 'Content pushed on menu reveal')?></span>
                    </div>
                    <div class="list" id="nmno">
                        <a href="#" onclick="return false;" class="btn btn-switch" data-action="toggle" data-class="nav-mobile-no-overlay"></a>
                        <span class="onoffswitch-title"><?= Yii::t('art/layout', 'No Overlay')?></span>
                        <span class="onoffswitch-title-desc"><?= Yii::t('art/layout', 'Removes mesh on menu reveal')?></span>
                    </div>
                    <div class="list" id="sldo">
                        <a href="#" onclick="return false;" class="btn btn-switch" data-action="toggle" data-class="nav-mobile-slide-out"></a>
                        <span class="onoffswitch-title"><?= Yii::t('art/layout', 'Off-Canvas')?></span>
                        <span class="onoffswitch-title-desc"><?= Yii::t('art/layout', 'Content overlaps menu')?></span>
                    </div>
                    <div class="mt-4 d-table w-100 px-5">
                        <div class="d-table-cell align-middle">
                            <h5 class="p-0">
                                <?= Yii::t('art/layout', 'Accessibility')?>
                            </h5>
                        </div>
                    </div>
                    <div class="list" id="mbf">
                        <a href="#" onclick="return false;" class="btn btn-switch" data-action="toggle" data-class="mod-bigger-font"></a>
                        <span class="onoffswitch-title"><?= Yii::t('art/layout', 'Bigger Content Font')?></span>
                        <span class="onoffswitch-title-desc"><?= Yii::t('art/layout', 'content fonts are bigger for readability')?></span>
                    </div>
                    <div class="list" id="mhc">
                        <a href="#" onclick="return false;" class="btn btn-switch" data-action="toggle" data-class="mod-high-contrast"></a>
                        <span class="onoffswitch-title"><?= Yii::t('art/layout', 'High Contrast Text (WCAG 2 AA)')?></span>
                        <span class="onoffswitch-title-desc"><?= Yii::t('art/layout', '4.5:1 text contrast ratio')?></span>
                    </div>
                    <div class="list" id="mcb">
                        <a href="#" onclick="return false;" class="btn btn-switch" data-action="toggle" data-class="mod-color-blind"></a>
                        <span class="onoffswitch-title"><?= Yii::t('art/layout', 'Daltonism')?> </span>
                        <span class="onoffswitch-title-desc"><?= Yii::t('art/layout', 'color vision deficiency')?></span>
                    </div>
                    <div class="list" id="mpc">
                        <a href="#" onclick="return false;" class="btn btn-switch" data-action="toggle" data-class="mod-pace-custom"></a>
                        <span class="onoffswitch-title"><?= Yii::t('art/layout', 'Preloader Inside')?></span>
                        <span class="onoffswitch-title-desc"><?= Yii::t('art/layout', 'preloader will be inside content')?></span>
                    </div>
                    <div class="list" id="mpi">
                        <a href="#" onclick="return false;" class="btn btn-switch" data-action="toggle" data-class="mod-panel-icon"></a>
                        <span class="onoffswitch-title"><?= Yii::t('art/layout', 'SmartPanel Icons (not Panels)')?></span>
                        <span class="onoffswitch-title-desc"><?= Yii::t('art/layout', 'smartpanel buttons will appear as icons')?></span>
                    </div>
                    <div class="mt-4 d-table w-100 px-5">
                        <div class="d-table-cell align-middle">
                            <h5 class="p-0">
                                <?= Yii::t('art/layout', 'Global Modifications')?>
                            </h5>
                        </div>
                    </div>
                    <div class="list" id="mcbg">
                        <a href="#" onclick="return false;" class="btn btn-switch" data-action="toggle" data-class="mod-clean-page-bg"></a>
                        <span class="onoffswitch-title"><?= Yii::t('art/layout', 'Clean Page Background')?></span>
                        <span class="onoffswitch-title-desc"><?= Yii::t('art/layout', 'adds more whitespace')?></span>
                    </div>
                    <div class="list" id="mhni">
                        <a href="#" onclick="return false;" class="btn btn-switch" data-action="toggle" data-class="mod-hide-nav-icons"></a>
                        <span class="onoffswitch-title"><?= Yii::t('art/layout', 'Hide Navigation Icons')?></span>
                        <span class="onoffswitch-title-desc"><?= Yii::t('art/layout', 'invisible navigation icons')?></span>
                    </div>
                    <div class="list" id="dan">
                        <a href="#" onclick="return false;" class="btn btn-switch" data-action="toggle" data-class="mod-disable-animation"></a>
                        <span class="onoffswitch-title"><?= Yii::t('art/layout', 'Disable CSS Animation')?></span>
                        <span class="onoffswitch-title-desc"><?= Yii::t('art/layout', 'Disables CSS based animations')?></span>
                    </div>
                    <div class="list" id="mhic">
                        <a href="#" onclick="return false;" class="btn btn-switch" data-action="toggle" data-class="mod-hide-info-card"></a>
                        <span class="onoffswitch-title"><?= Yii::t('art/layout', 'Hide Info Card')?></span>
                        <span class="onoffswitch-title-desc"><?= Yii::t('art/layout', 'Hides info card from left panel')?></span>
                    </div>
                    <div class="list" id="mlph">
                        <a href="#" onclick="return false;" class="btn btn-switch" data-action="toggle" data-class="mod-lean-subheader"></a>
                        <span class="onoffswitch-title"><?= Yii::t('art/layout', 'Lean Subheader')?></span>
                        <span class="onoffswitch-title-desc"><?= Yii::t('art/layout', 'distinguished page header')?></span>
                    </div>
                    <div class="list" id="mnl">
                        <a href="#" onclick="return false;" class="btn btn-switch" data-action="toggle" data-class="mod-nav-link"></a>
                        <span class="onoffswitch-title"><?= Yii::t('art/layout', 'Hierarchical Navigation')?></span>
                        <span class="onoffswitch-title-desc"><?= Yii::t('art/layout', 'Clear breakdown of nav links')?></span>
                    </div>
                    <div class="list" id="mdn">
                        <a href="#" onclick="return false;" class="btn btn-switch" data-action="toggle" data-class="mod-nav-dark"></a>
                        <span class="onoffswitch-title"><?= Yii::t('art/layout', 'Dark Navigation')?></span>
                        <span class="onoffswitch-title-desc"><?= Yii::t('art/layout', 'Navigation background is darkend')?></span>
                    </div>
                    <hr class="mb-0 mt-4">
                    <div class="mt-4 d-table w-100 pl-5 pr-3">
                        <div class="d-table-cell align-middle">
                            <h5 class="p-0">
                                <?= Yii::t('art/layout', 'Global Font Size')?>
                            </h5>
                        </div>
                    </div>
                    <div class="list mt-1">
                        ...
                        <span class="onoffswitch-title-desc d-block mb-0"><?= Yii::t('art/layout', 'Change <strong>root</strong> font size to effect rem values (resets on page refresh)')?></span>
                    </div>
                    <hr class="mb-0 mt-4">
                    <div class="mt-4 d-table w-100 pl-5 pr-3">
                        <div class="d-table-cell align-middle">
                            <h5 class="p-0 pr-2 d-flex">
                                <?= Yii::t('art/layout', 'Theme colors')?>
...
<!--                                <a href="#" class="ml-auto fw-400 fs-xs" data-toggle="popover" data-trigger="focus" data-placement="top" title="" data-html="true" data-content="This is a brand new technique we are introducing which uses CSS variables to infiltrate color options. While this has been working nicely on modern browsers without much issues, some users <strong>may still face issues on Internet Explorer </strong>. Until these issues are resolved or Internet Explorer improves, this feature will remain in Beta" data-original-title="<span class='text-primary'><i class='fal fa-question-circle mr-1'></i> Why beta?</span>" data-template="<div class=&quot;popover bg-white border-white&quot; role=&quot;tooltip&quot;><div class=&quot;arrow&quot;></div><h3 class=&quot;popover-header bg-transparent&quot;></h3><div class=&quot;popover-body fs-xs&quot;></div></div>"><i class="fal fa-question-circle mr-1"></i> why beta?</a>-->
                    ...
                    <div class="pl-5 pr-3 py-3">
                        <div class="ie-only alert alert-warning d-none">
                            <h6><?= Yii::t('art/layout', 'Internet Explorer Issue')?></h6>
                            <?= Yii::t('art/layout', 'This particular component may not work as expected in Internet Explorer. Please use with caution.')?>
                        </div>
                    ...
                    <div class="pl-5 pr-3 py-3 bg-faded">
                        <div class="row no-gutters">
                            <div class="col-6 pr-1">
                                <a href="#" class="btn btn-outline-danger fw-500 btn-block" data-action="app-reset"><?= Yii::t('art/layout', 'Reset Settings')?></a>
                            </div>
                            <div class="col-6 pl-1">
                                <a href="#" class="btn btn-danger fw-500 btn-block" data-action="factory-reset"><?= Yii::t('art/layout', 'Factory Reset')?></a>
                            </div>
                        </div>
                    </div>
